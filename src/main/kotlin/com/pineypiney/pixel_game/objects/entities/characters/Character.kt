...
import com.pineypiney.pixel_game.screens.MovementMechanics
...
abstract class Character(var scene: LittleGameScene, id: ResourceKey): AnimatedObject2D(id), Interactable {
    ...
    override fun checkHover(ray: Ray, screenPos: Vec2): Boolean {
        val ray2 = scene.camera.getRay(screenPos)
        val rect = Rect(position - scale/2, scale)
        val h = ray2.passesThroughRect(rect)
        return h
    }
