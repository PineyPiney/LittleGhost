...
import com.pineypiney.pixel_game.objects.menu_items.dialogue.ChoiceDialogue
import com.pineypiney.pixel_game.objects.menu_items.dialogue.DialogueBubble
import com.pineypiney.pixel_game.objects.menu_items.dialogue.SimpleDialogue
import glm_.i
import glm_.vec2.Vec2
import java.io.File

class ScriptProcessor(val game: LittleLogic, script: File): Initialisable {

    constructor(game: LittleLogic, script: String): this(game, File("src/main/resources/dialogue/$script.dlg"))
